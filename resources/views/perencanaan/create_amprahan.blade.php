...
<div class="container box">
    <h3 align="center">Masukan Data Amprahan</h3><br />

    <br />
    <br />

    <form action="/perencanaan/amprahan/store" method="post">
        {{ csrf_field() }}
        ...
        <div class="form-group">
            <select name="jenis anggaran" id="jenis_anggaran" class="form-control input-lg dynamic"
                data-dependent="rincian_anggaran">
        ...
        <br />
        <div class="form-group">
            <select name="rincian anggaran" id="rincian_anggaran" class="form-control input-lg dynamic"
                data-dependent="kode_akun_lengkap">
